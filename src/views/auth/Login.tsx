...
const Login = () => {
  ...
  // Usuarios de ejemplo (en una aplicación real esto vendría de una API)
  const sampleUsers = [
    {
  ...
  const handleSubmit = (e: any) => {
    ...
    setTimeout(() => {
      ...
      if (user) {
        // Guardar información del usuario en localStorage (simulado)
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Accede a tu cuenta para gestionar tu perfil
          </p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-6 bg-gray-50 p-4 rounded-lg">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <p>
                <strong>Administrador:</strong> admin@institucion.edu / admin123
              </p>
              <p>
                <strong>Docente:</strong> profesor@institucion.edu / profesor123
              </p>
              <p>
                <strong>Estudiante:</strong> estudiante@institucion.edu /
                estudiante123
              </p>
            </div>
          </div>
